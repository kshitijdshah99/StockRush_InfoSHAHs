...
const SectorPage2 = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get('http://localhost:4000/api/ser/get/Telecommunication', {
                    headers: {
    ...
    const stockList = [
        { name: "Airtel", id: "65b109f21c94e053c42886bc" },
        { name: "Jio", id: "65b109f81c94e053c42886be" },
        { name: "Vodafone", id: "65b10a001c94e053c42886c0" },
        { name: "BSNL", id: "65b10a081c94e053c42886c2" },
        { name: "IDEA", id: "65b10a151c94e053c42886c4" }
    ];
  ...
  const handleSell = async (companyId, index) => {
    ...
    return (
        <div className="sector-page-container">
            <h2>Telecommunication Sector</h2>
            {loading ? (
                <p>Loading...</p>
            ) : (
