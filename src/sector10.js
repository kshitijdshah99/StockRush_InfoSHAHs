...
const SectorPage10 = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get('http://localhost:4000/api/ser/get/Healthcare', {
                    headers: {
    ...
    const stockList = [
        { name: "Sun Pharma", id: "65b1342b6122e8ced9b6613f" },
        { name: "Cipla", id: "65b134436122e8ced9b66141" },
        { name: "Doctor Reddy's Labs", id: "65b1345b6122e8ced9b66143" },
        { name: "Mankind Pharma", id: "65b134696122e8ced9b66145" },
        { name: "Abbott India", id: "65b1347d6122e8ced9b66147" }
    ];
  ...
  const handleSell = async (companyId, index) => {
    ...
    return (
        <div className="sector-page-container">
            <h2>Healthcare and Pharma Based</h2>
            {loading ? (
                <p>Loading...</p>
            ) : (
