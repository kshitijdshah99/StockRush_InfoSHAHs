...
const SectorPage4 = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get('http://localhost:4000/api/ser/get/Steel', {
                    headers: {
    ...
    const stockList = [
        { name: "TATA Steel", id: "65b10a7d1c94e053c42886d0" },
        { name: "ESSAR Steel", id: "65b10a9b1c94e053c42886d2" },
        { name: "Jindal Steel", id: "65b10aa21c94e053c42886d4" },
        { name: "JSW Steel Ltd.", id: "65b10ac21c94e053c42886d6" },
        { name: "Visa Steel", id: "65b12e326122e8ced9b66107" }
    ];
