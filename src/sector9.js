...
const SectorPage9 = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get('http://localhost:4000/api/ser/get/Tyres', {
                    headers: {
    ...
    const stockList = [
        { name: "MRF tyres", id: "65b133106122e8ced9b66135" },
        { name: "CEAT", id: "65b133286122e8ced9b66137" },
        { name: "Michelin", id: "65b1337c6122e8ced9b66139" },
        { name: "Bridgestone", id: "65b1339c6122e8ced9b6613b" },
        { name: "Apollo tyres", id: "65b133db6122e8ced9b6613d" }
    ];
  ...
  const handleSell = async (companyId, index) => {
    ...
    return (
        <div className="sector-page-container">
            <h2>Tyre Manufacturing Companies</h2>
            {loading ? (
                <p>Loading...</p>
            ) : (
